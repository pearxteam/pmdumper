...
public class PMDumper
{
    ...
    public void preInit(FMLPreInitializationEvent e)
    {
        ...
        md.modId = ID;
        md.version = VERSION;
        md.description = "Dump ALL the things: from items to advancements!";
        md.autogenerated = false;
        md.authorList = Arrays.asList("mrAppleXZ");
        md.url = "https://minecraft.curseforge.com/projects/pm-dumper";
        md.updateJSON = "https://raw.githubusercontent.com/PearXTeam/pmdumper/2.x.x-1.12/update.json";
    }
